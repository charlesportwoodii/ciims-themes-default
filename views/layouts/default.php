<?php $this->beginContent('//layouts/main'); ?>
	<div class="content">
		...
		<div class="sidebar pure-u-1-3 pull-right">
            ...
            <h4><?php echo Yii::t('themes.default.main', 'Categories'); ?></h4>
			<?php $this->widget('zii.widgets.CMenu', array(
                'items' => $this->theme->getCategories()
            )); ?>

            <h4><?php echo Yii::t('themes.default.main', 'Recent Posts'); ?></h4>
			<?php $this->widget('zii.widgets.CMenu', array(
			...
			<?php if ($this->theme->twitterHandle != NULL && $this->theme->twitterTweetsToFetch > 0): ?>
				<h4><?php echo Yii::t('themes.default.main', 'Recent Tweets'); ?></h4>
			...
			<?php if ($this->theme->facebookUserId != NULL): ?>
				<h4><?php echo Yii::t('themes.default.main', 'Recent Facebook Stories'); ?></h4>
			...
			<?php if ($this->theme->googlePlusUserId != NULL): ?>
				<h4><?php echo Yii::t('themes.default.main', 'Recent Google+ Activities'); ?></h4>
